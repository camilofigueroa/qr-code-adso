    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-12 col-lg-1 ">
                <a href="reporteexcel_tabla.php"><input class="btn btn-md btn-primary btn-block" type="submit" value="Registrados"></a>
            </div>
        <div class="col-xs-12 col-md-12 col-lg-8 well">
            ...
            <a href="reporteexcel_tabla.php"><input class="btn btn-md btn-primary btn-block" type="submit" value="Generar estadistica"></a>
        </div>
