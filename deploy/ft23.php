...
define("USERNAME", "sena"); // Your default username.
define("PASSWORD", "sena"); // Your default password.
...
$ft["settings"]["PERMISSION"]        = 0644; // 0644 Permission for uploaded files.
...
$ft["settings"]["FILEBLACKLIST"]     = "ft2.php filethingie.js ft.css ft_config.php"; // Specific files that will not be shown.
