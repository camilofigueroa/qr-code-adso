 ...
 */
    ...
    {    
        ...
        echo "<div style='font-family: Arial; font-size: 40px; margin-left: 100px; margin-top: 300px; margin-bottom: 230px;'>";
        echo $obj_nucleo->retornar_dato_tabla( "num_doc", $_REQUEST[ 'data' ], " nombres ", "nombres", "tb_personas", "../"  )."<br><br>";
        echo $obj_nucleo->retornar_dato_tabla( "num_doc", $_REQUEST[ 'data' ], " apellidos ", "apellidos", "tb_personas", "../"  )."<br>";
        echo "</div>";
    ...
    echo "<div style='margin-left: 100px; margin-top: 200px; float: left;'>";
    echo "<IMG SRC='../imagenes/espacio.JPG'>";
    echo "</div>";

    //--------En esta parte trabajamos la imagen------------------------------
    echo "<div style='margin-left: 250px; margin-top: 0px; float: left;'>";
    ...
    echo "<br><br><br>";
    echo "</div><a href=\"#\" onclick=\"printInfo(this)\">Imprimir</a>";
